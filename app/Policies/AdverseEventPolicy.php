...
/**
 * Intentionally permissive: any authenticated user may manage adverse events.
 *
...
class AdverseEventPolicy
{
     ...
     */
    public function view(User $user, AdverseEvent $adverseEvent): bool
    {
        return true;
    }
