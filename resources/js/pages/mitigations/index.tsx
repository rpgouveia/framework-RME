...
export default function MitigationsIndex({ mitigations }: Props) {
    ...
    const [categoria, setCategoria] =
        useState<FiltroCategoria>('all');

    const [mitigacaoSelecionada, setMitigacaoSelecionada] =
    ...
    const [custoEstimado, setCustoEstimado] =
        useState('');
    ...
    const mitigacoesFiltradas =
        categoria === 'all'
            ...
            : mitigations.data.filter(
                  (mitigation) =>
                      mitigation.saeri_category === categoria,
              );
            ...
            <main className="mitigations-page">
                ...
                <header className="mitigations-header">
                    ...
                    <p className="mitigations-description">
                        Escolha o risco já cadastrado, uma mitigação
                        do catálogo e defina o responsável e o custo
                        estimado. Campos marcados com * são
                        obrigatórios.
                    </p>
                ...
                <section className="mitigations-section">
                    ...
                    >
                        ...
                        <option value="2">
                            Alucinação em respostas
                        </option>

                    </select>

                    <p className="mitigations-help">
                        Somente riscos já cadastrados podem ser
                        selecionados.
                    </p>
                ...
                <section className="mitigations-section">
                    ...
                    <div className="mitigations-grid">
                        ...
                        {mitigacoesFiltradas.map(
                            (mitigation) => {

                                const selecionada =
                                    mitigacaoSelecionada ===
                                    mitigation.id;
                    ...
                    {mitigacoesFiltradas.length === 0 && (
                        ...
                        <p className="mitigations-empty">
                            Nenhuma mitigação encontrada nesta
                            categoria.
                        </p>
                ...
                <section className="mitigations-section">
                    ...
                    <div className="mitigations-details-grid">
                        ...
                        <div>
                            ...
                            <p className="mitigations-help">
                                Papel organizacional — não é permitido
                ...
                <section className="mitigations-rule">
                    ...
                    <p>
                        ...
                        {' '}
                        o botão "Salvar vínculo" permanece
                        desabilitado enquanto nenhum risco estiver
                        selecionado — não é possível cadastrar uma
                    ...
                    <p>
                        ...
                        {' '}
                        o vínculo nasce com status Declarada, gera
                        um registro no histórico e o sistema calcula
                        automaticamente a próxima data de revisão
                        somando a data de criação ao intervalo de
                        revisão periódica definido no protocolo de
                        monitoramento.
                    </p>
